...
- **Emergency sessions**: re-authenticate a human with a WebAuthn passkey,
  GitHub OAuth App device flow, or TOTP, then issue a session-scoped GitHub user or Secret-bound
